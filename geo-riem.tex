...
%			y con $\theta=t$ tenemos la solución.
	...
	\begin{ejer*}[Geodésicas en una superficie de revolución]\leavevmode
		
		 (Ver \href{https://github.com/dan-gc/geo-riem/blob/main/geo-sup-rev.nb}{\texttt{geo-sup-rev.nb}} y \href{https://github.com/dan-gc/curvas-superficies/blob/main/curvas-superficies.pdf}{\texttt{curvas-superficies.pdf}} p. 54)
...
%		\begin{align*}
%			\frac{d^2u}{dt}+\Gamma^1_11\left(\frac{du}{dt}\right)^2+\Gamma^1_{12}\frac{du}{dt}\frac{dv}{dt}+\Gamma^2_{22}\left(\frac{dv}{dt}\right)^2&=0\\
%			\frac{d^2v}{dt}+\Gamma^2_{11}\left(\frac{du}{dt}\right)^2+2\Gamma^2_{12}\frac{du}{dt}\frac{dv}{dt}+\Gamma^2_{22\left(\frac{dv}{dt}\right)^2&=0
%		\end{align*}
