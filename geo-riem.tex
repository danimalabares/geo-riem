...
%	los elementos básicos del módulo $\T^r_s(M)$ serán los campos tensoriales que a cada punto de la variedad asignan el producto tensorial de un elemento de $\bigotimes_rTM^*$ y uno de $\bigotimes_sTM$
	...
	\end{defn}
	Para encontrar una expresión de los símbolos de Christoffel en términos de los coeficientes locales de la métrica, $g_{ij}$, hagamos el siguiente ejemplo:
	\begin{ejem}[Símbolos de Christoffel en $\Hy^2$.]
		Dada la métrica en el semiplano superior
		\[g_{11}=E=\frac{1}{y^2_0},\qquad g_{12}=g_{21}=F=0,\qquad g_{22}=G=\frac{1}{y^2_0},\]
		...
		\begin{align*}
			\langle D_{\frac{\partial}{\partial x}}\frac{\partial}{\partial x},\frac{\partial}{\partial x}\rangle&=\Gamma_{11}^1\langle \frac{\partial}{\partial x},\frac{\partial}{\partial x}\rangle+\Gamma_{11}^2\langle \frac{\partial}{\partial x},\frac{\partial}{\partial y}\rangle=\Gamma_{11}^1\frac{1}{y^2}\\
			\langle D_{\frac{\partial}{\partial x}}\frac{\partial}{\partial x},\frac{\partial}{\partial y}\rangle&=\Gamma_{11}^1\langle \frac{\partial}{\partial x},\frac{\partial}{\partial y}\rangle+\Gamma_{11}^2\langle \frac{\partial}{\partial y},\frac{\partial}{\partial y}\rangle=\Gamma_{11}^2\frac{1}{y^2}
		\end{align*}
	\end{ejem}
	\chapter{Referencias}
