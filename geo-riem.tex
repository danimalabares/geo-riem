...
%	los elementos básicos del módulo $\T^r_s(M)$ serán los campos tensoriales que a cada punto de la variedad asignan el producto tensorial de un elemento de $\bigotimes_rTM^*$ y uno de $\bigotimes_sTM$
	...
	Recordemos que la base del espacio de 1-formas está dada por productos cuña ascendentes de la base dual \cref{prop:base-kth-exterior-power}. Por linealeadad, basta estudiar el caso en que
	...
	=\left|\begin{matrix}
		...
		Xg&Yg&Zg\\
	\end{matrix}\right|\]
	Expaniendo este determinante, obtenemos que
	\begin{align*}
